...
for ti=half_kern+1:nConv-half_kern
    ...
    % compute dot product (dont forget to flip the kernel backwards!)
...
%%% Take a deep breath: Youre about to make your first time-frequency
%   power plot!
...
% IMPORTANT! Im omitting a few steps of convolution 
