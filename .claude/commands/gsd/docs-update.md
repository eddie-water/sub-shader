...
<execution_context>
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/workflows/docs-update.md end-to-end.
