...
```bash
INIT=$(node "/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/spec.md.
