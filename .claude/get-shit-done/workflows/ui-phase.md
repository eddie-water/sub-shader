...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-ui-checker.md for instructions.
