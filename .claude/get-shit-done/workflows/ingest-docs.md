...
```bash
INIT=$(node "/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
