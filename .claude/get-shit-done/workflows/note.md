...
- **Global scope**: `/home/eddie-water/dev/python/sub-shader/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/eddie-water/dev/python/sub-shader/.claude/notes/`)
...
2. Glob `/home/eddie-water/dev/python/sub-shader/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/eddie-water/dev/python/sub-shader/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/eddie-water/dev/python/sub-shader/.claude/notes/` — works in any directory
