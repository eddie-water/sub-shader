...
See /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/discovery.md
...
Use /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/discovery.md.
