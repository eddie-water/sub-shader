...
INSTALL_JS_GLOBAL="/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
