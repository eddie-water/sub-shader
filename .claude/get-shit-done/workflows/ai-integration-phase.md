...
<required_reading>
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/ai-frameworks.md
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-eval-planner.md for instructions.
