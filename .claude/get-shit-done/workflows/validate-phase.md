...
```
Task(
  prompt="Read /home/eddie-water/dev/python/sub-shader/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/VALIDATION.md`
