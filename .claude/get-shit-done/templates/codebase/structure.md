...
- Usage: Reference from command with `@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/eddie-water/dev/python/sub-shader/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/eddie-water/dev/python/sub-shader/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
