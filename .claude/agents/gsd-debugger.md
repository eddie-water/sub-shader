...
<required_reading>
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/eddie-water/dev/python/sub-shader/.claude
                  → checks /home/eddie-water/dev/python/sub-shader/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done
                  → writes to /home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/hooks/
...
@/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/common-bug-patterns.md
