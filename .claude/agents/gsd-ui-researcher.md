...
Use template from `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/UI-SPEC.md`
