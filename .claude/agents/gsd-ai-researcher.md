...
<required_reading>
Read `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
