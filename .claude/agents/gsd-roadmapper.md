...
Reference full template: `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/eddie-water/dev/python/sub-shader/.claude/get-shit-done/templates/state.md`.
