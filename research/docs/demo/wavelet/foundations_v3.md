# DSP Documentation Structure v3
...
- Need a way to measure "how much" of each ingredient or building block exists in a signal = "how similar" to each of its building block patterns
