...
| `decay_rate` | `0.001` | Exponential decay rate per frame applied to global_max |
...
[WRITE: "What each parameter controls and when to change it — e.g., lower decay_rate means slower adaptation to quieter passages; higher percentile is more robust to transient spikes; increase num_frames to show more history"]
